...
const VerifyEmail = () => {
    ...
    <div className=" absolute top-1/2 left-1/2  translate-x-[-50%] translate-y-[-50%]">
                <div className=" max-w-md mx-auto flex flex-col bg-slate-100 shadow-slate-400 shadow-md justify-center items-center p-6">
                        ...
                        <form onSubmit={submitHandler} className="flex flex-col gap-4">
                            ...
                            <div>
                                <button disabled={loading}  
                                    className=" bg-green-500 font-semibold text-white px-2 py-1 rounded-md w-fit mx-auto disabled:opacity-75 ">
                                        {loading ? 'verifying...' :'verify Now'} 
                                </button>
                                    
                                <button type="button" className=" bg-orange-500 font-semibold text-white px-2 py-1 rounded-md w-fit mx-auto disabled:opacity-75"> resend the code </button>
                            </div>
                        </form>
